...
ATTR_ITEM = "item"
ATTR_PERIOD = "period"         # Period string like "5m", "1d", "1month"
ATTR_RENAME = "rename"
ATTR_REQUIRING = "requiring"   # Boolean flag if item requires action
ATTR_STATUS = "status"
...
class TodoServices(StrEnum):
    ...
    CREATE_LIST = "create_list"  # New service to create todo lists dynamically
...
class TodoListEntityFeature(IntFlag):
    ...
    SET_REQUIRING_ON_ITEM = 128   # Support for 'requiring' flag on items
    SET_PERIOD_ON_ITEM = 256      # Support for 'period' (due period string)
